...
const ExecFlagType EXEC_FIXED_POINT_END = registerDefaultExecFlag("FIXED_POINT_END");
const ExecFlagType EXEC_FIXED_POINT_BEGIN = registerDefaultExecFlag("FIXED_POINT_BEGIN");
